...
export const scenariosListResponseItem = zod.object({
  ...
  "lifeExpectancy": zod.array(zod.object({
  "type": zod.enum(['fixed', 'normal', 'uniform']).describe('* `fixed` - Fixed\n* `normal` - Normal\n* `uniform` - Uniform'),
  ...
  "investmentTypes": zod.array(zod.object({
  ...
  "eventSeries": zod.array(zod.object({
  ...
  "lower": zod.number().nullish(),
  "upper": zod.number().nullish()
}).optional().describe('Serializer for probability distributions'),
  "duration": zod.object({
  "type": zod.enum(['fixed', 'normal', 'uniform']).describe('* `fixed` - Fixed\n* `normal` - Normal\n* `uniform` - Uniform'),
  "value": zod.number().nullish(),
  "mean": zod.number().nullish(),
  ...
  "type": zod.enum(['income', 'expense', 'invest', 'rebalance']).describe('* `income` - Income\n* `expense` - Expense\n* `invest` - Invest\n* `rebalance` - Rebalance'),
  "initialAmount": zod.number().optional(),
  "changeAmtOrPct": zod.string().optional(),
  "changeDistribution": zod.object({
  "type": zod.enum(['fixed', 'normal', 'uniform']).describe('* `fixed` - Fixed\n* `normal` - Normal\n* `uniform` - Uniform'),
  "value": zod.number().nullish(),
  "mean": zod.number().nullish(),
  "stdev": zod.number().nullish(),
  ...
  "assetAllocation": zod.record(zod.string(), zod.any()).describe('Get initial asset allocation as dict'),
  "glidePath": zod.boolean().optional(),
  "assetAllocation2": zod.record(zod.string(), zod.any()).describe('Get final asset allocation for glide path'),
...
export const scenariosPartialUpdateBody = zod.object({
  ...
  "taxability": zod.boolean()
}).describe('Serializer for investment types')).optional(),
  "investments": zod.array(zod.object({
  "investmentType": zod.string(),
  "value": zod.number(),
  "taxStatus": zod.string(),
  "id": zod.string()
}).describe('Serializer for individual investments')).optional(),
  "eventSeries": zod.array(zod.object({
  ...
  "assetAllocation2": zod.record(zod.string(), zod.any()).describe('Get final asset allocation for glide path'),
  "maxCash": zod.number().optional()
}).describe('Serializer for event series with complex nested data')).optional(),
  "inflationAssumption": zod.object({
  "type": zod.enum(['fixed', 'normal', 'uniform']).describe('* `fixed` - Fixed\n* `normal` - Normal\n* `uniform` - Uniform'),
  "value": zod.number().nullish(),
  "mean": zod.number().nullish(),
...
export const scenariosValidateScenarioRetrieveResponse = zod.object({
  ...
  "investmentTypes": zod.array(zod.object({
  "name": zod.string().max(scenariosValidateScenarioRetrieveResponseInvestmentTypesItemNameMax),
  "description": zod.string(),
  "returnAmtOrPct": zod.string(),
  "returnDistribution": zod.object({
  "type": zod.enum(['fixed', 'normal', 'uniform']).describe('* `fixed` - Fixed\n* `normal` - Normal\n* `uniform` - Uniform'),
