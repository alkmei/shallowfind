...
export const adminUsersListResponseItem = zod.object({
  "id": zod.number(),
  "email": zod.string().email().max(adminUsersListResponseEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersCreateBody = zod.object({
  "email": zod.string().email().max(adminUsersCreateBodyEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersRetrieveResponse = zod.object({
  "id": zod.number(),
  "email": zod.string().email().max(adminUsersRetrieveResponseEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersUpdateBody = zod.object({
  "email": zod.string().email().max(adminUsersUpdateBodyEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersUpdateResponse = zod.object({
  "id": zod.number(),
  "email": zod.string().email().max(adminUsersUpdateResponseEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersPartialUpdateBody = zod.object({
  "email": zod.string().email().max(adminUsersPartialUpdateBodyEmailMax).optional().describe('Required. Enter a valid email address.'),
...
export const adminUsersPartialUpdateResponse = zod.object({
  "id": zod.number(),
  "email": zod.string().email().max(adminUsersPartialUpdateResponseEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersActivateCreateBody = zod.object({
  "email": zod.string().email().max(adminUsersActivateCreateBodyEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersActivateCreateResponse = zod.object({
  "id": zod.number(),
  "email": zod.string().email().max(adminUsersActivateCreateResponseEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersDeactivateCreateBody = zod.object({
  "email": zod.string().email().max(adminUsersDeactivateCreateBodyEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersDeactivateCreateResponse = zod.object({
  "id": zod.number(),
  "email": zod.string().email().max(adminUsersDeactivateCreateResponseEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersMakeStaffCreateBody = zod.object({
  "email": zod.string().email().max(adminUsersMakeStaffCreateBodyEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersMakeStaffCreateResponse = zod.object({
  "id": zod.number(),
  "email": zod.string().email().max(adminUsersMakeStaffCreateResponseEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersRemoveStaffCreateBody = zod.object({
  "email": zod.string().email().max(adminUsersRemoveStaffCreateBodyEmailMax).describe('Required. Enter a valid email address.'),
...
export const adminUsersRemoveStaffCreateResponse = zod.object({
  "id": zod.number(),
  "email": zod.string().email().max(adminUsersRemoveStaffCreateResponseEmailMax).describe('Required. Enter a valid email address.'),
